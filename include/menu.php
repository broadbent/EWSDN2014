...
?>
	...
	<div id="left-column" class="content-secondary">
		...
		<ul class="navlist" data-role="listview" data-inset="true" data-theme="d" data-divider-theme="b">
			...
			<li data-icon="false" <?php if ($mypage=="sponsors.php") echo 'class="navselected"' ?> ><a href="sponsors.php">Sponsors</a></li>
			...
			<li data-icon="false" class="subnav-a" data-theme="c"><a href="http://www.ewsdn.eu/previous/ewsdn13.html">EWSDN 2013</a></li>
			<li data-icon="false" class="subnav-a" data-theme="c"><a href="http://www.ewsdn.eu/previous/ewsdn12.html">EWSDN 2012</a></li>
		</ul>
	</div>
